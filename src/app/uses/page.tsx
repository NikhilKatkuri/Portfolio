              ...
              >
                ...
                <div className="flex flex-col gap-4">
                  {section.items.map((item) => (
                    <div
                      key={item.title}
                      className="group rounded-[28px]  cursor-pointer hover:bg-(--palette-grey-100)/40 transition-all ease-in-out duration-200 p-6 flex flex-col justify-between h-auto  w-full"
                    >
