      ...
      <div className="mx-auto max-w-content-mx w-full flex flex-col gap-8">
        <div>
          ...
          <div className="mb-6">
            <p className="paragraph-4 max-w-lg md:max-w-2xl text-left text-pretty ">
              <mark className="bg-theme-h-100-80 px-1 py-0.5 rounded-sm font-medium">
                {
          ...
          <div className="space-y-4 max-w-lg md:max-w-2xl text-left text-pretty  leading-relaxed">
            ...
            <p className="paragraph-5">
              While early in my career timeline, I bring genuine execution
              momentum, an honest assessment of my engineering gaps, and a track
              record of navigating complex documentation and production
        ...
        <div className="flex flex-col gap-6 my-6">
          <div className="grid sm:grid-cols-2 w-full border rounded-md border-theme-border-on-surface divide-y sm:divide-y-0 sm:divide-x divide-theme-on-surface/20">
            <div className="p-6 lg:p-8 cursor-pointer hover:bg-theme-h-100-80 flex flex-col justify-between h-auto w-full">
              <div className="mb-3">
            ...
            <div className="p-6 lg:p-8 cursor-pointer hover:bg-theme-h-100-80 flex flex-col justify-between h-auto w-full  border-t border-theme-border-on-surface">
              <div className="mb-3">
            ...
            <div className="p-6 lg:p-8 cursor-pointer hover:bg-theme-h-100-80 transition-all ease-in-out duration-200 flex flex-col justify-between h-auto w-full border-t border-theme-border-on-surface">
              <div className="mb-3">
